    ...
    <div>
      ...
      <section className="bg-gradient-to-br from-yellow-400 via-yellow-300 to-orange-400 py-20 px-4 text-center">
        ...
        <p className="text-orange-700 text-lg md:text-xl mb-8 max-w-2xl mx-auto">
          Premium bounce houses and party rentals — clean, safe, and ready for
          your next big event.
        </p>
        <div className="flex flex-wrap justify-center gap-4 mb-10">
          {["5-Star Rated", "Licensed & Insured", "Cleaned & Sanitized", "Easy Online Booking"].map(
            (badge) => (
              <span
                key={badge}
                className="bg-white text-orange-700 font-semibold px-4 py-2 rounded-full text-sm shadow"
              >
                ✓ {badge}
              </span>
            )
      ...
      {featuredItems.length > 0 && (
        <section className="bg-gray-50 py-16 px-4">
          <div className="max-w-7xl mx-auto">
            <h2 className="text-3xl font-black text-center text-orange-700 mb-10">
              Featured Rentals
            </h2>
      ...
      <section className="bg-orange-600 text-white text-center py-16 px-4">
        ...
        <div className="flex flex-wrap justify-center gap-4">
          <Link
            href="/rentals"
            className="bg-white text-orange-600 font-black px-6 py-3 rounded-full hover:bg-yellow-100 transition"
          >
            Browse Rentals
          </Link>
          <Link
            href="/contact"
            className="bg-orange-700 text-white font-black px-6 py-3 rounded-full hover:bg-orange-800 transition"
          >
            Contact Us
          </Link>
        </div>
